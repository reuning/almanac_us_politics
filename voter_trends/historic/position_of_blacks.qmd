...
levels <- c(1:3, 9)
variable <- "VCF0813"
var_levels <- c("Not much at all",
                "Some", "A lot", "Depends/Don't Know")
var_name <- "Position of Blacks"
...
The summary statistics are available [here](data/opinion_Position of Blacks.csv). The `Group N` column is the number of respondents in a given group in a given year while the `N` column is the number of respondents who selected the answer in the `Position of Blacks` column.
