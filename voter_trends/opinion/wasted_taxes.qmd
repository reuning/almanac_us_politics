...
levels <- c(1:3,9)
variable <- "VCF0606"
var_levels <- c("A lot", "Some", "Not very much",
        "Don't Know")
var_name <- "Waste Taxes"
...
The summary statistics are available [here](data/opinion_Waste Taxes). The `Group N` column is the number of respondents in a given group in a given year while the `N` column is the number of respondents who selected the answer in the `Waste Taxes` column.
