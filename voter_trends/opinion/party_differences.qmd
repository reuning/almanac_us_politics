...
levels <- c(1,2,9)
variable <- "VCF0501"
var_levels <- c("No difference", "Yes, a difference", 
        "Don't Know")
var_name <- "Party Differences"
...
The summary statistics are available [here](data/opinion_Party Differences.csv). The `Group N` column is the number of respondents in a given group in a given year while the `N` column is the number of respondents who selected the answer in the `Party Differences` column.
