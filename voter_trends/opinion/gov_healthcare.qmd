---
title: Government Health Insurance
---
...
levels <- c(1:7, 9)
variable <- "VCF0806"
var_levels <- c("1 - Gov insurance", "2", "3", "4", "5", "6", 
                "7 - Private insurance", "Don't Know")
var_name <- "Gov Healthcare"
...
The summary statistics are available [here](data/opinion_Gov Healthcare.csv). The `Group N` column is the number of respondents in a given group in a given year while the `N` column is the number of respondents who selected the answer in the `Gov Healthcare` column.
